...
Your response MUST be provided as a valid JSON object with the following structure:
{
  ...
  "scenes": [
    ...
    // Generate 8 scenes total
  ]
}"""

SONG_DESC_USER_PROMPT = f"""Analyze the following song and create a music video concept. For the artistic style choose one of the following. Think about the mood and the bmp of the song to determine the Scenes.
Anime
